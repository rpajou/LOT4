...
#   
  ...
  # Combine dataset by year and condition
  # conditions_files<-c(list.files(paste0(events_tmp, names(conditions_snomed_all[1])), "\\_start.rds$"),
  #                     list.files(paste0(events_tmp, names(conditions_snomed_all[1])), "\\_RCD.rds$"),
  #                     list.files(paste0(events_tmp, names(conditions_snomed_all[1])), "\\_SNOMED.rds$")
  #                     )
  # 
  # 
